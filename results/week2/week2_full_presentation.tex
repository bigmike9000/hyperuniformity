...
Note that $a = 1.0$ is the cloaked case --- the Bragg peaks vanish entirely because the
displacement cell exactly tiles the unit cell. Worth mentioning since $\bar{\Lambda}$ still
increases monotonically even as the long-range order disappears from two-point statistics.
}
