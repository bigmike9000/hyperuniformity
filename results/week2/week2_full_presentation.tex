...
\vspace{0.5em}
\textbf{Since then:} Validated URL and stealthy patterns; analyzed the Bombieri-Taylor cubic substitution.
\end{frame}
\note{
...
$\alpha \to \infty$: $S(k) = 0$ over a finite exclusion zone, not a power law. Exponential spreadability decay confirms this.
}

%----------------------------------------------------------------------
\begin{frame}{$\alpha$ Coverage So Far}
...
\vspace{0.5em}
All 2$\times$2 metallic-mean matrices give $\alpha = 3$ because $|\lambda_2| = 1/|\lambda_1|$.

\vspace{0.3em}
Professor Torquato suggested trying the Bombieri-Taylor cubic substitution (1986).
\end{frame}
\note{
...
\begin{itemize}
    ...
    \item Analyzed Bombieri-Taylor cubic substitution: $\alpha = 1.545$, $\bar{\Lambda} = 0.377$
    \item Confirmed Class II and III numerically (Period-Doubling, 0222)
\end{itemize}

\vspace{0.5em}
\textbf{Key finding:} Bombieri-Taylor gives $\alpha = 1.545$ --- a Class I quasicrystal in the previously empty $1 < \alpha < 2$ range.
