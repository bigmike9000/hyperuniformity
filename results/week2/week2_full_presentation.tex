...
Tested the perturbed lattice formula:
\[
...
\begin{tabular}{cccc}
\toprule
$\chi$ & $\bar{\Lambda}$ (measured) & $\bar{\Lambda}$ (predicted) & $\alpha$ \\
\midrule
0.1 & 1.02 & 1.01 & 2.0 \\
0.2 & 0.53 & 0.51 & 2.0 \\
0.3 & 0.36 & 0.34 & 2.0 \\
...
\vspace{0.5em}
\textbf{Key observation:} $\bar{\Lambda} \approx 1/(\pi^2 \chi)$ --- good agreement with theory.

\vspace{0.3em}
Higher $\chi$ (larger exclusion zone) $\Rightarrow$ better hyperuniformity, approaching lattice as $\chi \to \infty$.
\end{frame}
\note{
...
Larger exclusion zone = better suppression of fluctuations.
