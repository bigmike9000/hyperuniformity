...
The measured values follow the theoretical prediction $\bar{\Lambda} \approx 1/(\pi^2 \chi)$. Larger exclusion zones (higher $\chi$) yield lower $\bar{\Lambda}$, approaching the lattice value $1/6$ as $\chi \to \infty$. However, for finite $\chi$, stealthy patterns have $\bar{\Lambda} > 1/6$.
...
\begin{enumerate}
    \item The perfect lattice achieves the optimal $\bar{\Lambda} = 1/6$. Stealthy patterns approach this limit as $\chi \to \infty$.
...
\begin{enumerate}
    ...
    \item \textbf{Characterized} stealthy patterns: $\bar{\Lambda} \approx 1/(\pi^2 \chi)$, approaching lattice-level order as $\chi$ increases.
\end{enumerate}
