...
\begin{frame}{Spreadability Method}
  ...
  {\small(Torquato, 2021; Hitin-Bialus et al., 2024)}.
\end{frame}
\note{
  ...
  Applied to quasicrystals: Hitin-Bialus et al.\ (2024), Princeton thesis.
...
\note{
  Main result: all three chains give $\alpha\approx 3$,
