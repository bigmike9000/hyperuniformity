...
Period-Doubling & II  & $\Lambda_{II}(N)$     & 0.1284 & 0.1233 (needs $N > 10^5$) \\
...
4,882 pass the Pisot condition; 504 have complex conjugate eigenvalue pairs.

\textbf{Result:} All 504 give $\alpha = 2.000$ exactly (18 distinct $\lambda_1$ values). No matrix
fills $2 < \alpha < 3$.
...
Results (curve-fit primary): Period-Doubling $\Lambda_{II} = 0.080$;
0222 Chain $\Lambda_{III} = 0.209$ (using $\alpha = 0.684$, fitted).
Plateau cross-checks ($\Lambda_{II}^{\rm plat} = 0.123$, $\Lambda_{III}^{\rm plat} = 0.151$) are
