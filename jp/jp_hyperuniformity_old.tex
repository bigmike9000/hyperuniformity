...
$\bar{\Lambda}$ for the Silver ($\bar{\Lambda} = 1/4$, confirmed by high-precision simulation),
Bronze, Copper ($\bar{\Lambda} = 0.293$), and Nickel ($\bar{\Lambda} = 0.310$) chains;
the Silver $\bar{\Lambda} = 1/4$ and the Copper and Nickel values are reported here for
the first time.
